...
|-----------|----------|----------|---------------|
| [The Game](writeups/the-game.md) | TryHackMe | Game Hacking | Static Analysis, `strings` |
...
---
*This portfolio is actively maintained. New writeups are added as challenges are completed.*
